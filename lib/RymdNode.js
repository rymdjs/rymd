(function() {
  ...
  RymdNode.prototype = function() {
    ...
    var onAuthChallenge = function(peerName, data, connection) {
      ...
      console.log('onAuthChallenge', peerName, data);
      ...
      getPrivateKey.call(this).then(function(_privKey) {
        ...
        return this.crypto.decryptData(privKey, new Uint8Array(data)).then(function(test) {
          console.log('lol', test);
          return test;
        });
      }.bind(this))
      .then(function(dataView) {
        console.log('A', dataView);
        var theirNonce = dataView.subArray(0, 16);
        var idBuf = dataView.subArray(16);
    ...
    this.verifier.lookupIdentity(identity).then(function(peer) {
      ...
      .then(function(authChallenge) {
        connection.on('authResponse', onAuthResponse);
        return connection.sendAuthChallenge(authChallenge);
      });
      }.bind(this));
