  ...
  RymdNode.prototype = function() {
    ...
    var connect = function(identity) {
      ...
      this.verifier.lookupIdentity(identity).then(function(peer) {
        ...
        console.log('verified identity', peer);

        this.peers[identity] = peer;

        var firstEndpoint = peer.endpoints[Object.keys(peer.endpoints)[0]];
        ...
        this.network.connect(identity, firstEndpoint).then(onConnection);
